import type { Partecipante } from '@/content';
...
/**
 * Un Moderatore ha sempre tutti e tre i permessi finché resta in ruolo: non
 * si possono revocare, e l'interfaccia deve mostrarlo invece di lasciar
 * provare un gesto che il dominio rifiuterebbe.
 */
...
/** Stato iniziale: tutti possono tutto finché un Moderatore non decide altro. */
